  ...
  const experience = [
    {
      ...
      achievements: [
        'Built several responsive web applications for clients',
        'Contributed to major client projects',
        'Mentored junior developers and conducted code reviews',
        'Taught student web development for several cohorts',
        'Constructed a web development curriculum for the team'
      ]
    },
    {
      company: 'Freelance',
      ...
      description: 'Providing freelance web development services for various clients. Delivering custom websites and applications tailored to client needs.',
      achievements: [
        'Completed projects for multiple clients across different industries',
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:fasanyaadedayo14@gmail.com" className="text-blue-600 hover:underline">fasanyaadedayo14@gmail.com</a>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>Lagos, Nigeria</p>
                    <p className="text-sm text-gray-500 mt-1">West Africa Time (WAT, GMT+1)</p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="pt-6 mt-6 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    ...
                    {/* <a href="https://vercel.com/marie-adedayos-projects" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 hover:bg-gray-200 hover:text-blue-600 transition-colors cursor-pointer">
